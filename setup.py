...
setup(
    ...
    url="https://github.com/yourusername/stylegan-project",  # Replace with your GitHub URL
    packages=find_packages(exclude=["tests", "data", "notebooks"]),
    include_package_data=True,  # Ensures non-Python files like templates, configs are included
    classifiers=[
